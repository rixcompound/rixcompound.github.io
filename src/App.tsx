...
export default function App() {
  ...
  // Lock body scroll during loading to prevent scrolling into blank areas
  useEffect(() => {
    if (isLoading) {
      document.body.style.overflow = 'hidden';
      document.body.style.height = '100vh';
      document.body.style.touchAction = 'none'; // Prevent touch moving
    } else {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-neutral-100 relative overflow-x-hidden">
      ...
      {/* 2. Main Website Layout - Mounts and renders ONLY when loading is complete */}
      {!isLoading && (
        <div 
          id="appRoot" 
          className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col relative font-sans antialiased selection:bg-brand selection:text-black animate-fade-in transition-opacity duration-500"
        >
          {/* Navigation Menu */}
          <Navigation />
