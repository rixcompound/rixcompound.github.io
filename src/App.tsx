...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-neutral-100 relative overflow-x-hidden">
      ...
      <div 
        id="appRoot" 
        className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col relative font-sans antialiased selection:bg-brand selection:text-black animate-fade-in"
      >
        {/* Navigation Menu */}
        <Navigation />
        ...
        {showNotification && (
          <div
            className="fixed top-24 left-4 sm:left-6 lg:left-8 z-40 cursor-pointer max-w-[210px] sm:max-w-[240px] group select-none hover:-translate-y-1 transition-transform duration-350"
            onClick={(e) => {
              if ((e.target as HTMLElement).closest('.close-btn')) return;
              document.getElementById('rental-requirements')?.scrollIntoView({ behavior: 'smooth' });
            }}
          >
            <div className="relative overflow-hidden rounded-xl bg-neutral-950/98 border-2 border-amber-500 shadow-[0_15px_35px_rgba(234,179,8,0.3)] p-3 pr-8 hover:border-amber-400 hover:shadow-[0_20px_40px_rgba(234,179,8,0.45)] transition-all duration-300">
